...
export async function generateBoardResponse ({
  ...
  const formatInstructions = [
    'Формат ответа:',
    '1) Краткое резюме ситуации (не более 2 предложений).',
    '2) Для каждого члена совета: **[emoji + ИМЯ]:** максимум 1-2 лаконичных предложения, только с конкретными шагами.',
    '3) Синтез: 1-2 предложения с общим планом и различиями подходов.',
    'Если вопрос слишком расплывчатый или нет данных, сначала попроси уточнить, а не выдумывай советы.',
    '',
